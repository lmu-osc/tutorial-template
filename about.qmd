...
This tutorial was primarily written in YYYY using SOFTWARE-NAME SOFTWARE-VERSION. Major changes to the SOFTWARE-NAME can be found at the website [insert site URL] for the most up-to-date information, and to confirm that our tutorial is not out-of-date. 
